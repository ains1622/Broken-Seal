...
/// <summary>
/// Component to be attached to all weapons prefabs. The weapon prefab works together with the WeaponData
...
public abstract class Weapon : Item
{
    ...
    public class Stats : LevelData
    {
        ...
        [Header("Visuals")]
        public Proyectile projectilePrefab; // If attached, a pryectile will spawn every time the weapon cools down.
        ...
        public float damage, damageVariance, area, speed, cooldown, proyectileInterval, knockback;
        ...
        public static Stats operator +(Stats s1, Stats s2)
        {
            ...
            result.proyectileInterval = s1.proyectileInterval + s2.proyectileInterval;
    ...
    // For dinamically created weapons, call initialize to set everything up.
    ...
    // Lets us check wheter this weapon can attack at this current moment.
    ...
    // as well as the player's Might stat.
