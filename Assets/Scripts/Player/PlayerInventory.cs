...
public class PlayerInventory : MonoBehaviour
{
    ...
    public class Slot
    {
        ...
        public void Assign(Item assignedItem)
        {
            ...
            Debug.Log(string.Format("Assigned {0} to player", item.name, image.name));
        }
    ...
    // the slot number that an item was put in.
    ...
    public int Add(PassiveData data)
    {
        ...
        p.Initialise(data);
        go.transform.SetParent(transform); // Set the passive to be un hijo del jugador
    ...
    public bool LevelUp(Item item)
    {
        ...
        // If it is a passive, recalculate the player stats.
    ...
    void ApplyUpgradeOptions()
    {
        ...
        // <allUpgrades>, wich is the list of ALL upgrades in PlayerInventory.
