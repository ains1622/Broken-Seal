...
{
    // We will need to access the padding / spacing atributes on the layout.
    ...
    // You need to specify wich <inventory> to add the item to, and a list of all
    // <posibbleUpgrades> to show. It will select <pick> number of upgrades to show
    ...
    public void SetUpgrades(PlayerInventory inventory, List<ItemData> possibleUpgrades, int pick = 3, string tooltip = "")
    {
        ...
        // different attributtes like descriptions, etc.
        activeOptions = 0;
        ...
        // Sizes all the elemnts so they do not exceed the size of the boox
        RecalculateLayout();
    }
    ...
    {
        // Calculates the total avialable heifht for all the options, then divides it by the number of options
    ...
    void Update()
    {
        // Redraws the boxes in this elemnt if the screen size changes.
    ...
    // Just for convenience function to automatically populate our variables
